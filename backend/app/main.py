...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"] if "*" in settings.frontend_origin else settings.allowed_origins,
    allow_origin_regex=r"https://.*\.vercel\.app" if "vercel.app" in settings.frontend_origin else None,
